    ...
    var body: some View {
        ZStack {
            ...
            VStack{
                ...
                LineSecureField(txt: $forgotVM.txtNewPassword, isShowPassword: $forgotVM.isNewPassword,title: "New Password", placeholder: "Enter your new password")
                    .padding(.bottom, .screenWidth * 0.02)
                
                LineSecureField(txt: $forgotVM.txtConfirmPassword, isShowPassword: $forgotVM.isConfirmPassword, title: "Confirm Password", placeholder: "Enter your confirm password")
